class Competidor
    ...
    def initialize(str_codigo, str_nombre, int_edad, int_dni, str_nombre_equipo, str_color_cinturon, int_partidas_ganadas, int_partidas_empatadas, int_partidas_perdidas)
        @codigo = str_codigo
        @nombre = str_nombre
        @edad = int_edad
        @dni = int_dni
